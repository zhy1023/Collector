...
public class CommonAspect {
    ...
    public void beforeExecutionExtend(JoinPoint joinPoint) {
        Log.i(ConstValue.TAG, " ... [CommonAspect] beforeExecution ... Signature:"+joinPoint.getSignature() + "  Location:" + joinPoint.getSourceLocation());
    }
    ...
    public Object aroundExecutionExtend(ProceedingJoinPoint joinPoint) throws Throwable {
        Log.i(ConstValue.TAG, " ... [CommonAspect] aroundExecution ... Signature:"+joinPoint.getSignature() + "  Location:" + joinPoint.getSourceLocation());
    ...
    public void afterExecutionExtend(JoinPoint joinPoint) {
        Log.i(ConstValue.TAG, " ... [CommonAspect] afterExecution ... Signature:"+joinPoint.getSignature() + "  Location:" + joinPoint.getSourceLocation());
    }
    ...
    public void afterReturningExecutionExtend(JoinPoint joinPoint, Object returnVal) {
        Log.i(ConstValue.TAG, " ... [CommonAspect] afterReturningExecution ... Signature:"+joinPoint.getSignature() + "  Location:" + joinPoint.getSourceLocation() + " returnVal："+returnVal.toString());
    }
    ...
    public void afterThrowingExecutionExtend(JoinPoint joinPoint, Throwable e) {
        Log.i(ConstValue.TAG, " ... [CommonAspect] afterThrowingExecution ... Signature:"+joinPoint.getSignature() + "  Location:" + joinPoint.getSourceLocation() + " exception:"+e.toString());
    }
}
